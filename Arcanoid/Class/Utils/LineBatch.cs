...
namespace Arcanoid.Class.Utils {
    static public class LineBatch {
        ...
        static public void drawBoundingBox(Rectangle boundingBox, SpriteBatch sb) {
            LineBatch.DrawLine(sb, Color.White, new Vector2(boundingBox.Left, boundingBox.Top), new Vector2(boundingBox.Right, boundingBox.Top));
            LineBatch.DrawLine(sb, Color.White, new Vector2(boundingBox.Right, boundingBox.Top), new Vector2(boundingBox.Right, boundingBox.Bottom));
            LineBatch.DrawLine(sb, Color.White, new Vector2(boundingBox.Right, boundingBox.Bottom), new Vector2(boundingBox.Left, boundingBox.Bottom));
            LineBatch.DrawLine(sb, Color.White, new Vector2(boundingBox.Left, boundingBox.Bottom), new Vector2(boundingBox.Left, boundingBox.Top));
        }
